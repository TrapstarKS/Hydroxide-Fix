...
local releaseInfo = HttpService:JSONDecode(game:HttpGetAsync("https://api.github.com/repos/" .. user .. "/Hydroxide-Fix/releases"))[1]
            ...
            elseif web then
                if readFile and writeFile then
                    ...
                    if (isFile and not isFile(file)) or not importCache[asset] then
                        content = game:HttpGetAsync("https://raw.githubusercontent.com/" .. user .. "/Hydroxide-Fix/" .. branch .. '/' .. asset .. ".lua")
                    ...
                    assets = { loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/" .. user .. "/Hydroxide-Fix/" .. branch .. '/' .. asset .. ".lua"), asset .. '.lua')() }
                end
            else
